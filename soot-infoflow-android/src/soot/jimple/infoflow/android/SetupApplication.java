...
public class SetupApplication implements ITaintWrapperDataFlowAnalysis {
	...
	public List<String[]> SignatureResults;
	...
	public void printEntrypoints() {
		if (this.entrypoints == null)
			...
			for (SootClass sc : entrypoints)
				System.out.println("entrypoint: "+ sc.getName());
	...
	protected static interface IInPlaceInfoflow extends IInfoflow {
		...
		public List<String[]>runAnalysis(final ISourceSinkManager sourcesSinks, SootMethod entryPoint);
	...
	protected void processEntryPoint(ISourceSinkDefinitionProvider sourcesAndSinks,
		...
		this.SignatureResults = infoflow.runAnalysis(sourceSinkManager, entryPointCreator.getGeneratedMainMethod());
